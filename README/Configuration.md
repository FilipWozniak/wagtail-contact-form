...
2. Configure your email settings (`EMAIL_BACKEND`, `EMAIL_HOST` etc.), because without these settings `Django` will most
   likely return `ConnectionRefusedError` while attempting to submit the form.
